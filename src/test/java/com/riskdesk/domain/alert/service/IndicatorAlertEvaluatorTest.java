...
class IndicatorAlertEvaluatorTest {
    ...
    private static final Instant CLOSED_CANDLE = Instant.parse("2026-03-30T10:00:00Z");
    private static final Instant NEXT_CANDLE = Instant.parse("2026-03-30T11:00:00Z");
