...
class WtxPositionReconcilerTest {
    ...
    void paperTimeframe_returnsUnchanged_andNeverReadsTheRow() {
        ...
        WtxStrategyState out = reconciler.reconcile(paper, MNQ, CLOSE);
    ...
    void closePending_defersToSettler_andNeverReadsTheRow() {
        ...
        WtxStrategyState out = reconciler.reconcile(pending, MNQ, CLOSE);
    ...
    void aligned_long_sameFill_returnsUnchanged() {
        ...
        assertThat(reconciler.reconcile(in, MNQ, CLOSE)).isSameAs(in);
    }
    ...
    void sameSide_rowHasDifferentFill_correctsEntryBasis_preservesTrailing() {
        ...
        WtxStrategyState out = reconciler.reconcile(in, MNQ, CLOSE);
    ...
    void strategyFlat_rowActiveLong_adoptsFromFill() {
        ...
        WtxStrategyState out = reconciler.reconcile(liveFlat(), MNQ, CLOSE);
    ...
    void strategyLong_rowGone_flattensAndRealizesAtClose() {
        ...
        WtxStrategyState out = reconciler.reconcile(liveLong("18000.00", 2), MNQ, CLOSE);
