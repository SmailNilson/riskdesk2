...
export const api = {
  ...
  // Updates the VIRTUAL stop-loss / take-profit of a non-terminal position (chart move-to-price).
  // Either level may be omitted to update only the other. No broker order — the levels stay virtual
